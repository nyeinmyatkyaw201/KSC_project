...
export class ApiService {
  ...
  createBMember(Mydata:any){
    return this.http.post(`http://localhost:3000/api/v1/user/registrationmember/Bmembercreate`,Mydata)
  }
  getandDelete(id: any){
  ...
  Uploadedfile(){
    return this.http.get(`http://localhost:3000/api/v1/member/upload/getallfile`)
  }
  ...
  upploadAndCreate(data:any){
    return this.http.post(`http://localhost:3000/api/v1/A_member/recmember_of_upload`,data);
  }
